-- Staging: TPCDS STORE → clean column names + region classification
-- Region mapping is the foundation of the RLS security model
...
renamed AS (
    SELECT
        ...
        -- Region mapping must stay in sync with ANALYTICS_DB.SECURITY.USER_REGION_MAP
        CASE
